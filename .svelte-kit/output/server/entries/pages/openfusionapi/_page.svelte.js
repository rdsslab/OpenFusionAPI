import { a9 as ssr_context, aa as attr_class, ab as bind_props, ac as ensure_array_like, a8 as stringify, a7 as attr_style, e as escape_html, a5 as derived, a6 as attr, ad as clsx, ae as head } from "../../../chunks/index.js";
import "clsx";
  ...
  $$renderer.component(($$renderer2) => {
    ...
    Modal($$renderer2, {
      ...
      children: ($$renderer3) => {
        ...
        if (isOverlay) {
          $$renderer3.push(`<!--[0--><div class="notification is-warning is-light has-text-centered svelte-imjmcm"><span class="icon svelte-imjmcm"><i class="fa-solid fa-clock-rotate-left svelte-imjmcm"></i></span> <strong class="svelte-imjmcm">Your session has expired, please log in again</strong></div>`);
        } else {
          $$renderer3.push("<!--[-1-->");
        }
        ...
        {
          $$renderer3.push(`<!--[0--><span class="icon svelte-imjmcm"><i class="fa-solid fa-right-to-bracket svelte-imjmcm"></i></span> <span class="svelte-imjmcm">Sign In</span>`);
        }
